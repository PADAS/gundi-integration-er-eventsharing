...
from app.actions.er_syncer import ERSyncer
...
def test_creating_destination_event_categories(patchmock: Mock, catmock: Mock, source_event_categories, sample_auth_config, sample_action_config):
    ...
    sync = ERSyncer(auth_config = sample_auth_config, action_config = sample_action_config)
    sync._sync_event_categories()
...
@patch.object(ERSyncer, '_get_event_type_schema')
def test_sync_event_types(get_event_schema: Mock, get_event_types: Mock, post_event_type: Mock, sample_event_type, 
    ...
    sync = ERSyncer(auth_config = sample_auth_config, action_config = sample_action_config)
    sync._sync_event_types(['accident_rep'])
...
@patch('app.actions.er_syncer.ERSyncer._load_feature_group')
